                ...
                <div class="card-block">
                    ...
                    <form role="form" method="POST" action="{{ route('task.update',$task->id) }}">
                        ...
                        <div class="form-group col-4">
                            ...
                            <input type="date" class="form-control" id="date_to" name="date_to" value="{{ date('Y-m-d', strtotime($task->date_to)) }}">
                        ...
                        <div class="form-group col-4">
                            ...
                            <input type="date" class="form-control" id="date_from" name="date_from" value="{{ date('Y-m-d', strtotime($task->date_from)) }}">
                        ...
                        <div class="form-group col-12">
                            <label class="">
                                <input type="checkbox" name="status" id="status" value="1" {{ ($task->status === 1 ?'checked' :'') }}/>
                                Done
                            </label>
                        </div>
                        <div class="form-group col-12">
